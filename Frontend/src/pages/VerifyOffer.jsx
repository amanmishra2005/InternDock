...
export default function VerifyOffer() {
  ...
  const verifyDoc = async (verificationId) => {
    ...
    <div className="verify-page">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="verify-form">
            <div className="input-group">
              <label className="input-label">Enter Offer Verification ID</label>
              <div className="search-input-wrapper">
                <input
                  type="text"
                  placeholder="e.g. INT-OFFER-2026-XXXXX"
              ...
              <div className="success-content" style={{ width: "100%" }}>
                ...
                <div style={{ marginTop: "1.75rem" }}>
                  <OfferLetterPreview
                    ...
                    referenceId={result.referenceId || searchId}
      ...
      <style>{`
        ...
        .verify-icon-badge {
          ...
          box-shadow: 0 0 0 8px rgba(2, 132, 199, 0.05);
        }
